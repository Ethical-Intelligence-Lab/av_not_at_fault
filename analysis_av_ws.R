...
mean(as.numeric(d_subset$negligence_AV), trim = 0, na.rm = TRUE)
sd(as.numeric(d_subset$negligence_AV), na.rm = TRUE)
mean(as.numeric(d_subset$negligence_HDV), trim = 0, na.rm = TRUE)
sd(as.numeric(d_subset$negligence_HDV), na.rm = TRUE)

negligence_T <- t.test(negligence ~ cond, data = d_merged, paired = TRUE) 
negligence_T
...
mean(as.numeric(d_subset$capability_AV), trim = 0, na.rm = TRUE)
sd(as.numeric(d_subset$capability_AV), na.rm = TRUE)
mean(as.numeric(d_subset$capability_HDV), trim = 0, na.rm = TRUE)
sd(as.numeric(d_subset$capability_HDV), na.rm = TRUE)

capability_T <- t.test(capability ~ cond, data = d_merged, paired = TRUE) 
capability_T
...
mean(as.numeric(d_subset$fault_AV), trim = 0, na.rm = TRUE)
sd(as.numeric(d_subset$fault_AV), na.rm = TRUE)
mean(as.numeric(d_subset$fault_HDV), trim = 0, na.rm = TRUE)
sd(as.numeric(d_subset$fault_HDV), na.rm = TRUE)

fault_T <- t.test(fault ~ cond, data = d_merged, paired = TRUE) 
fault_T
