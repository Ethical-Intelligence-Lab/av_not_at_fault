...
cohen.d(d_merged[d_merged$cond_name=="av", ]$vB_sue, d_merged[d_merged$cond_name=="human", ]$vB_sue)
...
cohen.d(d_merged[d_merged$cond_name=="av", ]$defec, d_merged[d_merged$cond_name=="human", ]$defec)
...
cohen.d(d_merged[d_merged$cond_name=="av", ]$negl, d_merged[d_merged$cond_name=="human", ]$negl)
...
cohen.d(d_merged[d_merged$cond_name=="av", ]$countf, d_merged[d_merged$cond_name=="human", ]$countf)
...
cohen.d(d_merged[d_merged$cond_name=="av", ]$capab, d_merged[d_merged$cond_name=="human", ]$capab)
...
cohen.d(d_merged[d_merged$cond_name=="av", ]$fault, d_merged[d_merged$cond_name=="human", ]$fault)
...
cohen.d(d_merged[d_merged$cond_name=="av", ]$superh, d_merged[d_merged$cond_name=="human", ]$superh)
